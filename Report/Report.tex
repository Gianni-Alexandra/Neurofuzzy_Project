...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[l]{\footnotesize Coding project}
...
\begin{document}
	...
	\begin{titlepage}
		...
		\HRule \\[0.5cm]
		{ \huge Coding Project}\\[0.4cm] % Title of your document
		\HRule \\[1.8cm]
	...
	\input{Sources/literature_review.tex}
	\input{Sources/methodology.tex}
	\input{Sources/nn_architecture.tex}
	\input{Sources/training_algorithm.tex}
	\input{Sources/train.tex}
