...
Text tokenization is the process of reformatting a piece of text into smaller units called “tokens.”  It converts unstructured text into model-understandable structured data. Tokenization is a process that divides text into meaningful units, such as words, phrases, sentences, etc., so that these units can be fed into machine learning models. It’s one of the first and most important steps in natural language preprocessing, and often goes hand-in-hand with text vectorization.
