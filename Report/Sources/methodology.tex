...
A great example of \say{noise} is URLs, email addresses, lines like \say{This post was published on the site} (\textit{which can be often found at the start of an article}).
